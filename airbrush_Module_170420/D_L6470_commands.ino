...
//set up -------------------------------------
void L6470_setup(){
  L6470_setparam_acc(START_ACC_VAL);          //[R, WS] 加速度default 0x08A (12bit) (14.55*val+14.55[step/s^2])
  L6470_setparam_dec(START_DEC_VAL);          //[R, WS] 減速度default 0x08A (12bit) (14.55*val+14.55[step/s^2])
  L6470_setparam_maxspeed(START_MAX_SPD_VAL); //[R, WR]最大速度default 0x041 (10bit) (15.25*val+15.25[step/s])
  L6470_setparam_minspeed(START_MIN_SPD);     //[R, WS]最小速度default 0x000 (1+12bit) (0.238*val[step/s])
  L6470_setparam_fsspd(START_FSSPD);          //[R, WR]μステップからフルステップへの切替点速度default 0x027 (10bit) (15.25*val+7.63[step/s])
  L6470_setparam_kvalhold(START_KVALHOLD);    //[R, WR]停止時励磁電圧default 0x29 (8bit) (Vs[V]*val/256)
  L6470_setparam_kvalrun(START_KVALRUN);      //[R, WR]定速回転時励磁電圧default 0x29 (8bit) (Vs[V]*val/256)
  L6470_setparam_kvalacc(START_KCALACC);      //[R, WR]加速時励磁電圧default 0x29 (8bit) (Vs[V]*val/256)
  L6470_setparam_kvaldec(START_KVALDEC);      //[R, WR]減速時励磁電圧default 0x29 (8bit) (Vs[V]*val/256)
  L6470_setparam_stepmood(START_STEPMODE);    //ステップモードdefault 0x07 (1+3+1+3bit)
  L6470_setparam_ocdth(START_OCDTH);          //[R, WR]過電流しきい値default 0x8 (4bit) (375*val+375[mA])
  L6470_setparam_stallth(START_STALLTH);      //[R, WR]失速電流しきい値default 0x40 (7bit) (31.25*val+31.25[mA])

  L6470_setparam_config(START_STATUS);        //[R, WH]各種設定default 0x2e88 (3+3+2+1+1+1+1+1+3bit)


  L6470_setparam_intspd(START_INTSPD);        //[R, WH]逆起電力補償切替点速度default 0x0408 (14bit) (0.238*val[step/s])
  L6470_setparam_stslp(START_STSLP);          //[R, WH]逆起電力補償低速時勾配default 0x19 (8bit) (0.000015*val[% s/step])
  L6470_setparam_fnslpacc(START_FNSLPACC);    //[R, WH]逆起電力補償高速時加速勾配default 0x29 (8bit) (0.000015*val[% s/step])
  L6470_setparam_fnslpdec(START_FNSLPDEC);    //[R, WH]逆起電力補償高速時減速勾配default 0x29 (8bit) (0.000015*val[% s/step])  
